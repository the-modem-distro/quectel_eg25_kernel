...
static struct rt5616_init_reg init_list[] = {
    ...
    { RT5616_ADDA_CLK1,     0x0004 } ,
    { RT5616_ADDA_CLK2,     0x0C00 } ,
    { RT5616_GLB_CLK,       0x5000 } ,
    { RT5616_PLL_CTRL1,     0x1704 } ,
    { RT5616_PLL_CTRL2,     0x0800 } ,
    ...
    { RT5616_JD_CTRL1,      0x0000 } ,
    { RT5616_JD_CTRL2,      0x0000 } ,

    { RT5616_IRQ_CTRL1,     0x0000 } ,
    { RT5616_IRQ_CTRL2,     0x0001 } ,
    { RT5616_INT_IRQ_ST,    0x0900 } ,

    { RT5616_GPIO_CTRL1,    0x0100 } ,
    { RT5616_GPIO_CTRL2,    0x0000 } ,

    { RT5616_ADJ_HPF_CTRL1, 0xB320 } ,
    { RT5616_ADJ_HPF_CTRL2, 0x0000 } ,
			...
			unsigned int freq_in, unsigned int freq_out)
{
	...
	dev_dbg(dai->dev, "rt5616_set_dai_pll source: %d, freq_in: %d, freq_out: %d\n", source, freq_in, freq_out);	
	dev_dbg(dai->dev, "rt5616_set_dai_pll rt5616->pll_src: %d, rt5616->pll_in: %d, rt5616->pll_out: %d\n", rt5616->pll_src, rt5616->pll_in, rt5616->pll_out);
			...
			enum snd_soc_bias_level level)
{
	...
	case SND_SOC_BIAS_ON:
        //printk(KERN_EMERG "[Eddy]0 %s : %d\n", __func__, level);
        // 2017-09-19, eddy.qin init other reg
        snd_soc_write(codec, RT5616_ADC_DIG_VOL, 0x5c5c);
        snd_soc_write(codec, RT5616_D_MISC, 0x0011);
		snd_soc_write(codec, RT5616_PWR_DIG1, 0x9806);
		snd_soc_write(codec, RT5616_PWR_DIG2, 0x8800);
		snd_soc_write(codec, RT5616_PWR_ANLG1, 0xf8fe);
		snd_soc_write(codec, RT5616_PWR_ANLG2, 0x0a00);
		snd_soc_write(codec, RT5616_PWR_MIXER, 0xcc00);
		snd_soc_write(codec, RT5616_PWR_VOL, 0x3f00);
        // end eddy.qin
		break;
