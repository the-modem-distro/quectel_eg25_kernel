...
static DECLARE_TLV_DB_SCALE(max9860_mic_tlv, 0, 1, 0);
...
static SOC_ENUM_DOUBLE_DECL(max9867_mux_enum,
	MAX9867_INPUTCONFIG, MAX9867_INPUT_L_SHIFT, MAX9867_INPUT_R_SHIFT,
	max9867_mux);
...
static const struct snd_kcontrol_new max9867_snd_controls[] = {
	...
	SOC_DOUBLE_R_TLV("Mic Volume", MAX9867_LEFTMICGAIN,
			MAX9867_RIGHTMICGAIN, 0, 20, 1, max9860_mic_tlv),
...
static const struct snd_soc_dapm_widget max9867_dapm_widgets[] = {
	...
	SND_SOC_DAPM_ADC("Left ADC", NULL, MAX9867_PWRMAN, 1, 0),
	SND_SOC_DAPM_ADC("Right ADC", NULL, MAX9867_PWRMAN, 0, 0),
	...
	SND_SOC_DAPM_MIXER("Mic Mixer", SND_SOC_NOPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_MIXER("Line Mixer", SND_SOC_NOPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_INPUT("HCIN"),
...
static const struct snd_soc_dapm_route max9867_audio_map[] = {
	...
	{"DAI_IN", NULL, "Input Mux"},
	{"Input Mux", "Line", "Line Mixer"},
	{"Input Mux", "Mic", "Mic Mixer"},
	{"Input Mux", "Mic_Line", "Input Mixer"},
	
	{"Mic Mixer", NULL, "Left ADC"},
	{"Mic Mixer", NULL, "Right ADC"},
	{"Left ADC", NULL, "HCIN"},
	{"Right ADC", NULL, "HCIN"},
	{"Line Mixer", NULL, "Left Line"},
	{"Line Mixer", NULL, "Right Line"},
	{"Left Line", "Switch", "HCIN",},
	{"Right Line", "Switch", "HCIN",},

	{"Input Mixer", NULL, "Mic Mixer"},
	{"Input Mixer", NULL, "Line Mixer"},
};
...
static int max9867_probe(struct snd_soc_codec *codec)
{
	...
	//add by grady, 2018-4-14
	snd_soc_write(codec, MAX9867_ADCLEVEL, 0x33);
        snd_soc_write(codec, MAX9867_LEFTVOL, 0x9);
        snd_soc_write(codec, MAX9867_RIGHTVOL, 0x9);
		...
		const struct i2c_device_id *id)
{
	...
	i2c->addr = 0x18; // achang-20180607:for Compatible with tlv320, must reset correct addr.
